...
export default function Contact() {
  return (
    <section id="contact" className="flex flex-col justify-start items-start py-12">
      ...
      <div className="container mx-auto mb-14 px-5">
        <ul className="flex flex-col justify-between lg:items-center lg:flex-row gap-4">
          <li className="flex items-center gap-5">
            ...
            <Link target="_blank" href="https://wa.me/+584249698437">
              +584249698437
            </Link>
          </li>
          <li className="flex items-center gap-5">
            <Image src={MailIcon} alt="phone" width={30} height={30} />
            <Link target="_blank" href="mailto:cmunoz21x@gmail.com">
              cmunoz21x@gmail.com
            </Link>
          </li>
          <li className="flex items-center gap-5">
          ...
          <li className="flex items-center gap-5">
            ...
            <Link target="_blank" href="https://www.github.com/cristobaljms/">
              cristobaljms
            </Link>
          </li>
        </ul>
